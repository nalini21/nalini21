...
<h4>Skills: <p>Python, C/C++, javascript, dart</p>
<h4>Frameworks: <p>Flutter,Firebase, Materialize</p>
<h4>Databases: <p>Firebase Firestore, MongoDB</p>
<h4>Tools: <p>Android Studio, Postman, Adobe XD, VS Code, Matlab</p>
